...
namespace ph_GUI_V1
{
    public partial class FTPfields : Form
    {
        public FTPfields()
        {
            InitializeComponent();
        ...
        //button clicks launch First test Paretos reports with different data etc
        
        private void button4_Click(object sender, EventArgs e)
        {
            this.Hide();
            reports1 rep = new reports1();
